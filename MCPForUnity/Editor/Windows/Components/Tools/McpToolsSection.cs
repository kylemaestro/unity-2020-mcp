...
namespace MCPForUnity.Editor.Windows.Components.Tools
{
    ...
    public class McpToolsSection
    {
        ...
        private VisualElement CreateBatchExecuteSettings()
        {
            ...
            {
                value = MCPForUnity.Editor.Helpers.Compat.MathCompat.Clamp(currentValue, 1, BatchExecute.AbsoluteMaxCommandsPerBatch),
                style = { width = 60 }
            };
            ...
            {
                int clamped = MCPForUnity.Editor.Helpers.Compat.MathCompat.Clamp(evt.newValue, 1, BatchExecute.AbsoluteMaxCommandsPerBatch);
